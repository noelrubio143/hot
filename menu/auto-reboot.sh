...
clear
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m                SENSI AUTO-REBOOT MENU                 \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e ""
...
echo -e "\e[1;35m 6 \e[0m Set Auto-Reboot Every 1 MoSENSIh"
...
echo "SENSI Auto-Reboot has been set every hour."
elif test $x -eq 2; then
echo "10 */6 * * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot has been successfully set every 6 hours."
elif test $x -eq 3; then
echo "10 */12 * * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot has been successfully set every 12 hours."
elif test $x -eq 4; then
echo "10 0 * * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot has been successfully set once a day."
elif test $x -eq 5; then
echo "10 0 */7 * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot has been successfully set once a week."
elif test $x -eq 6; then
echo "10 0 1 * * root /usr/local/bin/reboot_otomatis" > /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot has been successfully set once a moSENSIh."
elif test $x -eq 7; then
rm -f /etc/cron.d/reboot_otomatis
echo "SENSI Auto-Reboot successfully TURNED OFF."
elif test $x -eq 8; then
if [ ! -e /root/log-reboot.txt ]; then
	clear
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;34m                  SENSI AUTO-REBOOT LOG                 \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
...
echo " SENSI Auto Reboot Log successfully deleted! \e[0m"
echo -e ""
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo ""
read -n 1 -s -r -p "Press any key to go back to menu"
...
echo "worng options"
echo ""
read -n 1 -s -r -p "Press any key to go back to SENSI menu"
auto-reboot 
fi
